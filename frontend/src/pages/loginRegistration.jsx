...
import LegalPolicies from "../components/reusableComponents/LegalPolicies.jsx";
import "./loginRegistration.css";
import GoBackButton from "../components/reusableComponents/LRGoBackButton.jsx";
...
export default function LoginRegistration() {
  ...
  return (
    <div className="loginRegister">
            ...
            <div className="registerInputErrorBox">
              ...
              >
                ...
                <input
                  className="emailLogRegInput"
                  placeholder={
                    t("loginRegistration.registerTitlePassword") + "..."
                  }
      ...
      {emailCheckComplete &&
        !emailExists &&
        (currentStep === "register" || currentStep === "terms") &&
        (!isTermsVisible || currentStep !== "terms" ? (
          <div className="emailLogRegBox">
            <GoBackButton path="/email-check" />
              ...
              <div className="registerInputErrorBox">
                ...
                >
                  ...
                  <input
                    className="emailLogRegInput"
                    placeholder={
                      t("loginRegistration.registerTitleUsername") + "..."
                    }
                    value={usernameInput}
            ...
            <div className="registerBottom">
              <div className="registerInputErrorBox">
                <div
                  className={`emailLogRegCheckboxBox ${
                    termsError ? "error" : ""
                  }`}
                >
                  <input
                  ...
                  <p className="emailLogRegCheckbox">
                    ...
                    >
                      <strong>
                        {t("loginRegistration.registerLegalPolicies")}
                      </strong>
                    </a>
                  </p>
                </div>
