...
export default function LoginRegistration() {
  ...
  const registerData = t("loginRegistration.registerData", {
    returnObject: true,
  });
        ...
        <div className="emailLogRegBox">
          ...
          <div className="loginBottom">
            ...
            <a className="loginForgotPassword">
              You forgot your password, dont worry click here for a password
              reset
            </a>
          </div>
        </div>
            ...
            <div className="registerBottom">
              <div className="registerTermsAndConditionsBox">
                ...
                <p className="registerTermsAndConditions">
                  ...
                  <a
                    className="registerTermsAndConditionsLink"
                    onClick={handleTermsAndConditionsVisibility}
                  >
                    <strong>Legal Policies</strong>
                  </a>
                </p>
              </div>
              <button className="emailLogRegContinue">
